...
- [x] Events concept: Dispatcher/Occurrence/Receiver/Handler, независимый source contract, один subscription для arbitrary E; Base integration через test runtime. Core2 runtime API переименован в Fire с сохранением semantics overloads.
...
- [ ] Следующие слои согласовывать отдельными итерациями. Core2 production Commands/Events composition с Execution/Scope, FireEventCommand, Unity bridge, cancellation и Reset/Queue сейчас не реализованы.
